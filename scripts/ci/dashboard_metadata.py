        ...
        "tokenspeed_serve_smoke": {
            ...
            "repro": _workload_repro(
                ...
                success=(
                    ...
                    "output_throughput appear in perf.md. Two metrics are gated on "
                    "both cells — median_tpot_ms and p99_itl_ms, ceilings from the "
                    "2026-09-08..09-17 window — so a run over either fails the "
                    "nightly, and the breaching observation is still recorded and "
                    "charted in this cell's history for diagnosis. Every other "
                    "serving metric is "
                    "still record-only, including step_time_ms.max; see "
