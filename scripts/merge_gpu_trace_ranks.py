#!/usr/bin/env python3
"""
Enhanced GPU trace merger that better organizes processes for clearer visualization.
"""
...
def merge_gpu_traces_enhanced(trace_dir, output_file, num_ranks=8, trace_name='trace_step19.json'):
    """
