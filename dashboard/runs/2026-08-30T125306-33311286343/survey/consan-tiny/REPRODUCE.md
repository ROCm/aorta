...
Sanitizer case `consan-tiny` from run `2026-08-30T125306-33311286343` of the AORTA sanitizer nightly. This directory is the run area for that one case: its report, the sanitizer output the verdict came from, and the provenance below. See `index.html` for every file actually published here.
...
| Path | SHA-256 |
|---|---|
| `fixtures/isa/tiny.hsaco` | `ba7d97fb20d4f66886f85a1329ab320d88d37f12fa1d1624d637548aacfc2660` |
...
| Key | Value |
|---|---|
| `code_object:tiny.hsaco` | `ba7d97fb20d4f66886f85a1329ab320d88d37f12fa1d1624d637548aacfc2660` |
...
| `selected_identity_sha256` | `06c63a7cff06e7519e777da94f338e39cbc5e897703eba17e370e0e0ec2406b5` |
