...
Sanitizer case `consan-lds-dispatch` from run `2026-08-30T125306-33311286343` of the AORTA sanitizer nightly. This directory is the run area for that one case: its report, the sanitizer output the verdict came from, and the provenance below. See `index.html` for every file actually published here.
...
| Path | SHA-256 |
|---|---|
| `fixtures/isa/lds.hsaco` | `72d7d64769d0465b2f67726b3e93defc57bf4efc9dababb8a67320dd4e0cff12` |
...
| `selected_identity_sha256` | `1aaf1f0f379c1f5b919065a0ad90252188f15ff2e2441b858766e9c8806babd9` |
