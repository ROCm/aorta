...
Sanitizer case `consan-tiny` from run `2026-08-27T162009-33089985218` of the AORTA sanitizer nightly. This directory is the run area for that one case: its report, the sanitizer output the verdict came from, and the provenance below. See `index.html` for every file actually published here.
...
| Path | SHA-256 |
|---|---|
| `fixtures/isa/tiny.hsaco` | `682927c30ba191057c189fc16e6b5f1e19710950c7e1d979058d2bafcf0268d5` |
...
| Key | Value |
|---|---|
| `code_object:tiny.hsaco` | `682927c30ba191057c189fc16e6b5f1e19710950c7e1d979058d2bafcf0268d5` |
...
| `selected_identity_sha256` | `14b4a2edcb26e30e1ae2ebd64f9e335d75476abdc8dd55eded5c6d68050d6860` |
