...
Sanitizer case `consan-lds-dispatch` from run `2026-08-27T162009-33089985218` of the AORTA sanitizer nightly. This directory is the run area for that one case: its report, the sanitizer output the verdict came from, and the provenance below. See `index.html` for every file actually published here.

## Run

- Commit: `e61f455a130bf266c83730ac055cd208efe0af87`
- Date: 2026-08-27 16:20:09 UTC
- Target: `gfx950`
- Class: survey (observed-only, non-gating)
- Workflow run: https://github.com/ROCm/aorta/actions/runs/33089985218
...
| Path | SHA-256 |
|---|---|
| `fixtures/isa/lds.hsaco` | `d00809b2b8ace2b5421d859a0bdc4a3f3ee71ecb25facbee5ad9c524e5c2c933` |
...
| Key | Value |
|---|---|
| `code_object:lds.hsaco` | `d00809b2b8ace2b5421d859a0bdc4a3f3ee71ecb25facbee5ad9c524e5c2c933` |
...
| `selected_identity_sha256` | `e217c31317bdacc6767ca0d69684412db6270c72b447b943e4f5216e0b40ee22` |
