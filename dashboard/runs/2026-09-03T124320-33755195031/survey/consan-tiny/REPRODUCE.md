...
Sanitizer case `consan-tiny` from run `2026-09-03T124320-33755195031` of the AORTA sanitizer nightly. This directory is the run area for that one case: its report, the sanitizer output the verdict came from, and the provenance below. See `index.html` for every file actually published here.
...
| Path | SHA-256 |
|---|---|
| `fixtures/isa/tiny.hsaco` | `c9121617df6f38103e5193a99e656fa601607dec8f42e1470d020b3816370352` |
...
| Key | Value |
|---|---|
| `code_object:tiny.hsaco` | `c9121617df6f38103e5193a99e656fa601607dec8f42e1470d020b3816370352` |
...
| `selected_identity_sha256` | `788e21c24c7e87d4292703264e3d2266c075cdc4ce013c72dcea8df9627ff502` |
