...
Sanitizer case `consan-lds-dispatch` from run `2026-09-03T124320-33755195031` of the AORTA sanitizer nightly. This directory is the run area for that one case: its report, the sanitizer output the verdict came from, and the provenance below. See `index.html` for every file actually published here.

## Run

- Commit: `90dae9376bd3a09531478a72752ccb204e36fc5c`
- Date: 2026-09-03 12:43:20 UTC
- Target: `gfx950`
- Class: survey (observed-only, non-gating)
- Workflow run: https://github.com/ROCm/aorta/actions/runs/33755195031
...
| Path | SHA-256 |
|---|---|
| `fixtures/isa/lds.hsaco` | `582fda52d20d902ba652d6550f55f6beabd9b41c7799d3cd678fde9da3a0340c` |
...
| Key | Value |
|---|---|
| `code_object:lds.hsaco` | `582fda52d20d902ba652d6550f55f6beabd9b41c7799d3cd678fde9da3a0340c` |
...
| `selected_identity_sha256` | `d6e1a5bc8ab7b5ca2426b9bdf7ae4fe2e280c7c0c8e6cd62965d2f2276a60e5c` |
