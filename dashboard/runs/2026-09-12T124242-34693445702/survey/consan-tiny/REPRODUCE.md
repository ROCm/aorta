...
Sanitizer case `consan-tiny` from run `2026-09-12T124242-34693445702` of the AORTA sanitizer nightly. This directory is the run area for that one case: its report, the sanitizer output the verdict came from, and the provenance below. See `index.html` for every file actually published here.
...
| Path | SHA-256 |
|---|---|
| `fixtures/isa/tiny.hsaco` | `49d51bdd003dc2ff7ea26dcb263dc8d81d50c8ddc2b04f3823aae62667b51a19` |
...
| Key | Value |
|---|---|
| `code_object:tiny.hsaco` | `49d51bdd003dc2ff7ea26dcb263dc8d81d50c8ddc2b04f3823aae62667b51a19` |
...
| `selected_identity_sha256` | `3875f79d2af159c41c5e7bc3334195a56e3c78efeef2907edd800dda03cf8170` |
