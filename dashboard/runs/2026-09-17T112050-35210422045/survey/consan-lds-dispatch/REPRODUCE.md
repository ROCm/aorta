...
Sanitizer case `consan-lds-dispatch` from run `2026-09-17T112050-35210422045` of the AORTA sanitizer nightly. This directory is the run area for that one case: its report, the sanitizer output the verdict came from, and the provenance below. See `index.html` for every file actually published here.
...
- Execution: `error`
- Findings: 0
- Reason: `consan_output_parse_error: reader 104555477756752 access site count mismatch`
...
| Path | SHA-256 |
|---|---|
| `fixtures/isa/lds.hsaco` | `75d35abd7e15762e0c958c1e4957d4aff95c3c1b9535b96d61a133952c1e577a` |
...
| Key | Value |
|---|---|
| `code_object:lds.hsaco` | `75d35abd7e15762e0c958c1e4957d4aff95c3c1b9535b96d61a133952c1e577a` |
...
| `selected_identity_sha256` | `81eca89039519be72aed74d167ce802cce9eef2a84405992518fab074b6213a9` |
