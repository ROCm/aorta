...
Sanitizer case `consan-tiny` from run `2026-09-17T112050-35210422045` of the AORTA sanitizer nightly. This directory is the run area for that one case: its report, the sanitizer output the verdict came from, and the provenance below. See `index.html` for every file actually published here.
...
| Path | SHA-256 |
|---|---|
| `fixtures/isa/tiny.hsaco` | `00d7b78da53ed9c623ab88c18cbd83cd73583d4b946c1fb01c5b5b9e515fab57` |
...
| Key | Value |
|---|---|
| `code_object:tiny.hsaco` | `00d7b78da53ed9c623ab88c18cbd83cd73583d4b946c1fb01c5b5b9e515fab57` |
...
| `selected_identity_sha256` | `e1b6cfc9e4065310412318fcae9c7729a8ea9c5628133fddf3e69427cd60ffaf` |
