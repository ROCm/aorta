...
Sanitizer case `consan-lds-dispatch` from run `2026-09-24T142227-35998938187` of the AORTA sanitizer nightly. This directory is the run area for that one case: its report, the sanitizer output the verdict came from, and the provenance below. See `index.html` for every file actually published here.
...
| Path | SHA-256 |
|---|---|
| `fixtures/isa/lds.hsaco` | `7cde715c4d9be08fb2d2e7c61485484a0b12d7f6ce59635f90e02f6d6cf5a56a` |
...
| Key | Value |
|---|---|
| `code_object:lds.hsaco` | `7cde715c4d9be08fb2d2e7c61485484a0b12d7f6ce59635f90e02f6d6cf5a56a` |
...
| `selected_identity_sha256` | `abff367b6d091a7847b61c6db699eace31f6d77cab5e8362678c998d870a3d78` |
