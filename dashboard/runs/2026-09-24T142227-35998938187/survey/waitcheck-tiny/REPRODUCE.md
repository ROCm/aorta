...
Sanitizer case `waitcheck-tiny` from run `2026-09-24T142227-35998938187` of the AORTA sanitizer nightly. This directory is the run area for that one case: its report, the sanitizer output the verdict came from, and the provenance below. See `index.html` for every file actually published here.
...
| Path | SHA-256 |
|---|---|
| `fixtures/isa/tiny.hsaco` | `fb4587de48cf5d325ba515119e2528632647725fbb0360f1c7c61d2f5b6ab4a2` |

## Recorded digests

| Key | Value |
|---|---|
| `code_object:tiny.hsaco` | `fb4587de48cf5d325ba515119e2528632647725fbb0360f1c7c61d2f5b6ab4a2` |
