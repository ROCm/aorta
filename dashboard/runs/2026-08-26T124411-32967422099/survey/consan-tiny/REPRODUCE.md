...
Sanitizer case `consan-tiny` from run `2026-08-26T124411-32967422099` of the AORTA sanitizer nightly. This directory is the run area for that one case: its report, the sanitizer output the verdict came from, and the provenance below. See `index.html` for every file actually published here.
...
| Path | SHA-256 |
|---|---|
| `fixtures/isa/tiny.hsaco` | `b6b36b7d768ce45811516a141d656272ff7fd77d9fb18d33aae8a9a62da73913` |
...
| Key | Value |
|---|---|
| `code_object:tiny.hsaco` | `b6b36b7d768ce45811516a141d656272ff7fd77d9fb18d33aae8a9a62da73913` |
...
| `selected_identity_sha256` | `1c85e13bbab628020b89e22edff982d9849d88f738c1f080c68436560ac120c7` |
