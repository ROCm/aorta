...
Sanitizer case `consan-lds-dispatch` from run `2026-08-26T124411-32967422099` of the AORTA sanitizer nightly. This directory is the run area for that one case: its report, the sanitizer output the verdict came from, and the provenance below. See `index.html` for every file actually published here.

## Run

- Commit: `bed2771d52ddc0d81cdf28ac176611815c2358c7`
- Date: 2026-08-26 12:44:11 UTC
- Target: `gfx950`
- Class: survey (observed-only, non-gating)
- Workflow run: https://github.com/ROCm/aorta/actions/runs/32967422099
...
git checkout bed2771d52ddc0d81cdf28ac176611815c2358c7
pip install -e .
```
...
| Path | SHA-256 |
|---|---|
| `fixtures/isa/lds.hsaco` | `5db9509d14042b02d7ca63b64e901dc687ccad88c0f5b602fc0da756a37f4a1c` |
...
| Key | Value |
|---|---|
| `code_object:lds.hsaco` | `5db9509d14042b02d7ca63b64e901dc687ccad88c0f5b602fc0da756a37f4a1c` |
...
| `selected_identity_sha256` | `c19edc080f8587aef1bdcdec8e774a117d4be166e9f8c725024ee18a4741b4b3` |
