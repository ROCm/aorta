...
Sanitizer case `consan-lds-dispatch` from run `2026-09-14T124757-34843407133` of the AORTA sanitizer nightly. This directory is the run area for that one case: its report, the sanitizer output the verdict came from, and the provenance below. See `index.html` for every file actually published here.
...
| Path | SHA-256 |
|---|---|
| `fixtures/isa/lds.hsaco` | `552d43bd067f9064003c1ac1479e3dd5a42befb359d9d8a68ef29a91f3ea5e4c` |
...
| Key | Value |
|---|---|
| `code_object:lds.hsaco` | `552d43bd067f9064003c1ac1479e3dd5a42befb359d9d8a68ef29a91f3ea5e4c` |
...
| `selected_identity_sha256` | `9ce99f8e59b0dc60c6c8fd485228331837745e6eea4c9fc087c9dd5d2842367b` |
