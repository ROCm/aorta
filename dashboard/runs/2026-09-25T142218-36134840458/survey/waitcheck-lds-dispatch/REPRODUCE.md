...
Sanitizer case `waitcheck-lds-dispatch` from run `2026-09-25T142218-36134840458` of the AORTA sanitizer nightly. This directory is the run area for that one case: its report, the sanitizer output the verdict came from, and the provenance below. See `index.html` for every file actually published here.
...
| Path | SHA-256 |
|---|---|
| `fixtures/isa/lds.hsaco` | `24193ba0a7a7f6cf1fe2d5b75189c0183874fb71cb99f008efa01fa8a22d49f0` |

## Recorded digests

| Key | Value |
|---|---|
| `code_object:lds.hsaco` | `24193ba0a7a7f6cf1fe2d5b75189c0183874fb71cb99f008efa01fa8a22d49f0` |
