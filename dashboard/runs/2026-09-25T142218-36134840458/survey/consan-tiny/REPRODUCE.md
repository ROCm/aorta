...
Sanitizer case `consan-tiny` from run `2026-09-25T142218-36134840458` of the AORTA sanitizer nightly. This directory is the run area for that one case: its report, the sanitizer output the verdict came from, and the provenance below. See `index.html` for every file actually published here.

## Run

- Commit: `2f68c26d995d0e4ce555a267f0dd9ffdd00bd9b1`
- Date: 2026-09-25 14:22:18 UTC
- Target: `gfx950`
- Class: survey (observed-only, non-gating)
- Workflow run: https://github.com/ROCm/aorta/actions/runs/36134840458
...
git checkout 2f68c26d995d0e4ce555a267f0dd9ffdd00bd9b1
pip install -e .
```
...
| Path | SHA-256 |
|---|---|
| `fixtures/isa/tiny.hsaco` | `a78edb78d995b203929d3c22537453233ca5d1b37314383cd468bdd3126fe870` |
...
| Key | Value |
|---|---|
| `code_object:tiny.hsaco` | `a78edb78d995b203929d3c22537453233ca5d1b37314383cd468bdd3126fe870` |
...
| `hook_sha256` | `c2d24d4bb379690659630fe05f6ca27ff2b00ab8c979a6ed1d80c5df814cabd1` |
| `selected_identity_sha256` | `fd21ed88b369d15f6005728a1504d7988f184ffdc8596e4a8cfa49e8c63201da` |
