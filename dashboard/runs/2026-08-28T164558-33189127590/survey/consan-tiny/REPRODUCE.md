...
Sanitizer case `consan-tiny` from run `2026-08-28T164558-33189127590` of the AORTA sanitizer nightly. This directory is the run area for that one case: its report, the sanitizer output the verdict came from, and the provenance below. See `index.html` for every file actually published here.
...
| Path | SHA-256 |
|---|---|
| `fixtures/isa/tiny.hsaco` | `135929953ac643e59128244540077cf64e1d796a02c49679616ebe73dafd051b` |
...
| Key | Value |
|---|---|
| `code_object:tiny.hsaco` | `135929953ac643e59128244540077cf64e1d796a02c49679616ebe73dafd051b` |
...
| `selected_identity_sha256` | `02387633d757cba6a31a1d2d0793c59d59c95de650c081404e612bb3e41fb6f1` |
