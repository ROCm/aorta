...
Sanitizer case `consan-tiny` from run `2026-09-10T124939-34476548600` of the AORTA sanitizer nightly. This directory is the run area for that one case: its report, the sanitizer output the verdict came from, and the provenance below. See `index.html` for every file actually published here.
...
| Path | SHA-256 |
|---|---|
| `fixtures/isa/tiny.hsaco` | `02628914c71d46e2d24fbfb4c7497c9be53a4257da4e68310185d5af764696c5` |
...
| Key | Value |
|---|---|
| `code_object:tiny.hsaco` | `02628914c71d46e2d24fbfb4c7497c9be53a4257da4e68310185d5af764696c5` |
...
| `selected_identity_sha256` | `856f00188944f3cd96257122a90293754c0d5daf081637fae4b6a7596051084f` |
