...
Sanitizer case `consan-gemm` from run `2026-09-10T124939-34476548600` of the AORTA sanitizer nightly. This directory is the run area for that one case: its report, the sanitizer output the verdict came from, and the provenance below. See `index.html` for every file actually published here.

## Run

- Commit: `6a8c70da0addc997c2d7067a5ed28d043464d9b8`
- Date: 2026-09-10 12:49:39 UTC
- Target: `gfx950`
- Class: survey (observed-only, non-gating)
- Workflow run: https://github.com/ROCm/aorta/actions/runs/34476548600
...
git checkout 6a8c70da0addc997c2d7067a5ed28d043464d9b8
pip install -e .
```
