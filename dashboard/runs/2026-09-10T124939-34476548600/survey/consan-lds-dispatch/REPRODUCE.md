...
Sanitizer case `consan-lds-dispatch` from run `2026-09-10T124939-34476548600` of the AORTA sanitizer nightly. This directory is the run area for that one case: its report, the sanitizer output the verdict came from, and the provenance below. See `index.html` for every file actually published here.
...
| Path | SHA-256 |
|---|---|
| `fixtures/isa/lds.hsaco` | `2826114b7b5896e32b5cf508294779e425db68055a56bb8f7088ef2ecd4da58a` |
...
| Key | Value |
|---|---|
| `code_object:lds.hsaco` | `2826114b7b5896e32b5cf508294779e425db68055a56bb8f7088ef2ecd4da58a` |
...
| `selected_identity_sha256` | `7643bac14ff81c6f73adef8dc3fd4f674e7bf192a2528c2f7d0bb2432d96e869` |
