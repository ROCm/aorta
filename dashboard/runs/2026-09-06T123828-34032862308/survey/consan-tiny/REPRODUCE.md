...
Sanitizer case `consan-tiny` from run `2026-09-06T123828-34032862308` of the AORTA sanitizer nightly. This directory is the run area for that one case: its report, the sanitizer output the verdict came from, and the provenance below. See `index.html` for every file actually published here.
...
| Path | SHA-256 |
|---|---|
| `fixtures/isa/tiny.hsaco` | `76d69af3576c625341794377d0b9548e1d24c29e67de9fa46f5f4ad3aa9cc769` |
...
| Key | Value |
|---|---|
| `code_object:tiny.hsaco` | `76d69af3576c625341794377d0b9548e1d24c29e67de9fa46f5f4ad3aa9cc769` |
...
| `selected_identity_sha256` | `6dde72d651b7f627ae5cf53e99fcfe664ff7ec99517c30f09341338b9c21f2c5` |
