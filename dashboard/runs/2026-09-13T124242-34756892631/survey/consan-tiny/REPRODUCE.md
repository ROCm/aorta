...
Sanitizer case `consan-tiny` from run `2026-09-13T124242-34756892631` of the AORTA sanitizer nightly. This directory is the run area for that one case: its report, the sanitizer output the verdict came from, and the provenance below. See `index.html` for every file actually published here.
...
| Path | SHA-256 |
|---|---|
| `fixtures/isa/tiny.hsaco` | `a9f0f5636bd23392d29a1260afb611f5bd6a8972761d9b85584146958254742e` |
...
| Key | Value |
|---|---|
| `code_object:tiny.hsaco` | `a9f0f5636bd23392d29a1260afb611f5bd6a8972761d9b85584146958254742e` |
...
| `selected_identity_sha256` | `1fa60fe05dad7e850058820872b921cf7d19998003bc8c7c772f2787ddfbcdcb` |
