...
Sanitizer case `consan-lds-dispatch` from run `2026-09-13T124242-34756892631` of the AORTA sanitizer nightly. This directory is the run area for that one case: its report, the sanitizer output the verdict came from, and the provenance below. See `index.html` for every file actually published here.
...
| Path | SHA-256 |
|---|---|
| `fixtures/isa/lds.hsaco` | `04268db7e6e0cd7193b799baf7d35b1502e30e8caa5ac83cb79f97ca3c6abde0` |
...
| Key | Value |
|---|---|
| `code_object:lds.hsaco` | `04268db7e6e0cd7193b799baf7d35b1502e30e8caa5ac83cb79f97ca3c6abde0` |
...
| `selected_identity_sha256` | `d0bc8e7e30540f3330f7a629c6ffba550b194e399bbc38846599a796c3dcbad6` |
