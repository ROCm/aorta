...
Sanitizer case `consan-tiny` from run `2026-08-15-31883858931` of the AORTA sanitizer nightly. This directory is the run area for that one case: its report, the sanitizer output the verdict came from, and the provenance below. See `index.html` for every file actually published here.
...
| Path | SHA-256 |
|---|---|
| `fixtures/isa/tiny.hsaco` | `3add68e07374fc83f1746f921320efce08562828c3ea486818bc3db75d1a1b2f` |
...
| Key | Value |
|---|---|
| `code_object:tiny.hsaco` | `3add68e07374fc83f1746f921320efce08562828c3ea486818bc3db75d1a1b2f` |
...
| `selected_identity_sha256` | `412ec035cd60436cff69001bbb9492989be93b131e5e1e51ffd1bfd877a01c73` |
