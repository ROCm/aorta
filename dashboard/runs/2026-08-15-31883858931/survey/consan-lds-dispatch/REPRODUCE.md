...
Sanitizer case `consan-lds-dispatch` from run `2026-08-15-31883858931` of the AORTA sanitizer nightly. This directory is the run area for that one case: its report, the sanitizer output the verdict came from, and the provenance below. See `index.html` for every file actually published here.
...
- Workflow run: https://github.com/ROCm/aorta/actions/runs/31883858931
...
| Path | SHA-256 |
|---|---|
| `fixtures/isa/lds.hsaco` | `a935958871dd8ecc1aa556888027434d03f3c57510091675560873c7a8993339` |
...
| Key | Value |
|---|---|
| `code_object:lds.hsaco` | `a935958871dd8ecc1aa556888027434d03f3c57510091675560873c7a8993339` |
...
| `selected_identity_sha256` | `e6cd9ebd40efc85eada3d58c73fcca79ad6ca9fd1c7b46d70961ee559d397649` |
