...
Sanitizer case `consan-lds-dispatch` from run `2026-09-22T142217-35726994798` of the AORTA sanitizer nightly. This directory is the run area for that one case: its report, the sanitizer output the verdict came from, and the provenance below. See `index.html` for every file actually published here.
...
| Path | SHA-256 |
|---|---|
| `fixtures/isa/lds.hsaco` | `3e11b569e83a9a6306c339bfdc343d7fd5a021e8cb3b077d9ad2f80448027b51` |
...
| Key | Value |
|---|---|
| `code_object:lds.hsaco` | `3e11b569e83a9a6306c339bfdc343d7fd5a021e8cb3b077d9ad2f80448027b51` |
...
| `selected_identity_sha256` | `fa72a364c02548b40f495eaf20b0d9c3dfa62a3bcbef014a70571e2c212be3f9` |
