...
Sanitizer case `waitcheck-tiny` from run `2026-08-16-31946286609` of the AORTA sanitizer nightly. This directory is the run area for that one case: its report, the sanitizer output the verdict came from, and the provenance below. See `index.html` for every file actually published here.
...
| Path | SHA-256 |
|---|---|
| `fixtures/isa/tiny.hsaco` | `47b99b2d259fd727da5093ce0fb53840f5fb22e3c39f76698f61d9d2f38b9d36` |

## Recorded digests

| Key | Value |
|---|---|
| `code_object:tiny.hsaco` | `47b99b2d259fd727da5093ce0fb53840f5fb22e3c39f76698f61d9d2f38b9d36` |
