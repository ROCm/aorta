...
Sanitizer case `consan-lds-dispatch` from run `2026-08-16-31946286609` of the AORTA sanitizer nightly. This directory is the run area for that one case: its report, the sanitizer output the verdict came from, and the provenance below. See `index.html` for every file actually published here.
...
- Workflow run: https://github.com/ROCm/aorta/actions/runs/31946286609
...
| Path | SHA-256 |
|---|---|
| `fixtures/isa/lds.hsaco` | `e8e1f2ad6e4713dc4015166a9709ccca7e65b0d2de10839e29ff47e6d3d06eae` |
...
| Key | Value |
|---|---|
| `code_object:lds.hsaco` | `e8e1f2ad6e4713dc4015166a9709ccca7e65b0d2de10839e29ff47e6d3d06eae` |
...
| `selected_identity_sha256` | `50d8dded3a41dbaa5ba184692ba5fcbe52d4a8af6cb6985eca3be53215166dca` |
