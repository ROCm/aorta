...
Sanitizer case `consan-lds-dispatch` from run `2026-08-29T124958-33252284140` of the AORTA sanitizer nightly. This directory is the run area for that one case: its report, the sanitizer output the verdict came from, and the provenance below. See `index.html` for every file actually published here.
...
| Path | SHA-256 |
|---|---|
| `fixtures/isa/lds.hsaco` | `80f7d96e99bdb3487e9282533e95cbe3993f9a045208d5d5bfff76ceaaeb9792` |
...
| Key | Value |
|---|---|
| `code_object:lds.hsaco` | `80f7d96e99bdb3487e9282533e95cbe3993f9a045208d5d5bfff76ceaaeb9792` |
...
| `selected_identity_sha256` | `0d54907cc774e5c3c218d919d246e82113825a9bd437ab0fbe98c2e25191709f` |
