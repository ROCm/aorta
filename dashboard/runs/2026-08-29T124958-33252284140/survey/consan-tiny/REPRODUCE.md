...
Sanitizer case `consan-tiny` from run `2026-08-29T124958-33252284140` of the AORTA sanitizer nightly. This directory is the run area for that one case: its report, the sanitizer output the verdict came from, and the provenance below. See `index.html` for every file actually published here.
...
| Path | SHA-256 |
|---|---|
| `fixtures/isa/tiny.hsaco` | `ea2c7d56efdddcbca738aa937a9e3e5c131231ef57d3b32ab3578c958d61639c` |
...
| Key | Value |
|---|---|
| `code_object:tiny.hsaco` | `ea2c7d56efdddcbca738aa937a9e3e5c131231ef57d3b32ab3578c958d61639c` |
...
| `selected_identity_sha256` | `edc47b673d24cf3e51438dad384367a7df7adbb523c936a87a85d79d2da5bb5f` |
