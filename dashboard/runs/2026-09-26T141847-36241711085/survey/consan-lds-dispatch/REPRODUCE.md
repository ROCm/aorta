...
Sanitizer case `consan-lds-dispatch` from run `2026-09-26T141847-36241711085` of the AORTA sanitizer nightly. This directory is the run area for that one case: its report, the sanitizer output the verdict came from, and the provenance below. See `index.html` for every file actually published here.
...
| Path | SHA-256 |
|---|---|
| `fixtures/isa/lds.hsaco` | `2d0baa26585f3d97ecfcd28fa6bc1a0059029c56252d48f991da19a096cf45ed` |
...
| Key | Value |
|---|---|
| `code_object:lds.hsaco` | `2d0baa26585f3d97ecfcd28fa6bc1a0059029c56252d48f991da19a096cf45ed` |
...
| `selected_identity_sha256` | `dfe4aafd83751b64a51de58dd09b84d91285ebc1133e8bb26470c2fbdad6b439` |
