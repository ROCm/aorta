...
Sanitizer case `waitcheck-lds-dispatch` from run `2026-09-18T142430-35344430257` of the AORTA sanitizer nightly. This directory is the run area for that one case: its report, the sanitizer output the verdict came from, and the provenance below. See `index.html` for every file actually published here.
...
| Path | SHA-256 |
|---|---|
| `fixtures/isa/lds.hsaco` | `41bcc7371e04f3a3b5220f70bacc91ec630bbd9f80f9b71c86221f7d25b05f54` |

## Recorded digests

| Key | Value |
|---|---|
| `code_object:lds.hsaco` | `41bcc7371e04f3a3b5220f70bacc91ec630bbd9f80f9b71c86221f7d25b05f54` |
| `path` | `/workspace/aorta/.sanitizer-nightly/rocjitsu-prebuilt/bin/rj_waitcheck` |
| `sha256` | `e1d2e5451e02c418ec2b352504e5ded68e08ae1d6370d6251ef78b76e743b64a` |
