...
Sanitizer case `consan-lds-dispatch` from run `2026-09-17T074922-35189763335` of the AORTA sanitizer nightly. This directory is the run area for that one case: its report, the sanitizer output the verdict came from, and the provenance below. See `index.html` for every file actually published here.
...
- Execution: `error`
- Findings: 0
- Reason: `consan_output_parse_error: reader 101624374705504 access site count mismatch`
...
| Path | SHA-256 |
|---|---|
| `fixtures/isa/lds.hsaco` | `a97e68d1b17afd4d3b3c339dae6840881108718cc0edd780a78c2bb340da3c0c` |
...
| Key | Value |
|---|---|
| `code_object:lds.hsaco` | `a97e68d1b17afd4d3b3c339dae6840881108718cc0edd780a78c2bb340da3c0c` |
...
| `selected_identity_sha256` | `fb76ebb09e7500686fd3f0c11d80ea40b214f28f09bec709fe8c5bb268be651a` |
