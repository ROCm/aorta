...
Sanitizer case `consan-racy` from run `2026-09-17T074922-35189763335` of the AORTA sanitizer nightly. This directory is the run area for that one case: its report, the sanitizer output the verdict came from, and the provenance below. See `index.html` for every file actually published here.
...
- Execution: `error`
- Findings: 0
- Reason: `consan_output_parse_error: reader 104937374258048 access site count mismatch`
