...
Sanitizer case `consan-lds-dispatch` from run `2026-09-17T132440-35221004771` of the AORTA sanitizer nightly. This directory is the run area for that one case: its report, the sanitizer output the verdict came from, and the provenance below. See `index.html` for every file actually published here.

## Run

- Commit: `73409f79a56ac10ae5374b419e5737221daadc34`
- Date: 2026-09-17 13:24:40 UTC
- Target: `gfx950`
- Class: survey (observed-only, non-gating)
- Workflow run: https://github.com/ROCm/aorta/actions/runs/35221004771
...
- Execution: `error`
- Findings: 0
- Reason: `consan_output_parse_error: reader 95906335076368 access site count mismatch`
...
| Path | SHA-256 |
|---|---|
| `fixtures/isa/lds.hsaco` | `fc7ec48c27659cfec58e426bde4ddeeb853bf0aaec338a43ca409ea344921f00` |
...
| Key | Value |
|---|---|
| `code_object:lds.hsaco` | `fc7ec48c27659cfec58e426bde4ddeeb853bf0aaec338a43ca409ea344921f00` |
...
| `selected_identity_sha256` | `c70345d58ba6d8f8e85206f5a6a68ce9efa363f91ab6d31aa64c823b73643f3b` |
