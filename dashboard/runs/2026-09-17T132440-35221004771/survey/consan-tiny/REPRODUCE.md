...
Sanitizer case `consan-tiny` from run `2026-09-17T132440-35221004771` of the AORTA sanitizer nightly. This directory is the run area for that one case: its report, the sanitizer output the verdict came from, and the provenance below. See `index.html` for every file actually published here.
...
| Path | SHA-256 |
|---|---|
| `fixtures/isa/tiny.hsaco` | `151f434acbd91cd3173fea2458edae59a37be49f06bd968f3383472d83179f28` |
...
| Key | Value |
|---|---|
| `code_object:tiny.hsaco` | `151f434acbd91cd3173fea2458edae59a37be49f06bd968f3383472d83179f28` |
...
| `selected_identity_sha256` | `645f2a046c0a9d12b11849a18fe3aa36d01afa10d9f53698be6b73cdc3ec0a18` |
