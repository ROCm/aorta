...
Sanitizer case `consan-gemm` from run `2026-09-17T132440-35221004771` of the AORTA sanitizer nightly. This directory is the run area for that one case: its report, the sanitizer output the verdict came from, and the provenance below. See `index.html` for every file actually published here.
...
- Execution: `error`
- Findings: 0
- Reason: `consan_output_parse_error: reader 102132391194464 atomic site count mismatch`
