...
Sanitizer case `consan-tiny` from run `2026-09-03T103956-33743980591` of the AORTA sanitizer nightly. This directory is the run area for that one case: its report, the sanitizer output the verdict came from, and the provenance below. See `index.html` for every file actually published here.
...
| Path | SHA-256 |
|---|---|
| `fixtures/isa/tiny.hsaco` | `2fb5079448e32f8944a2fa2e09983ecd716a5090c5f934a9a03cc50927cd365a` |
...
| Key | Value |
|---|---|
| `code_object:tiny.hsaco` | `2fb5079448e32f8944a2fa2e09983ecd716a5090c5f934a9a03cc50927cd365a` |
...
| `selected_identity_sha256` | `b8e8d2110bd3de1dfd3a248d25614a02e4f0856973c6be69ee1225640b15fc4f` |
