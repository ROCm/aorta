...
Sanitizer case `consan-lds-dispatch` from run `2026-09-21T142115-35599335281` of the AORTA sanitizer nightly. This directory is the run area for that one case: its report, the sanitizer output the verdict came from, and the provenance below. See `index.html` for every file actually published here.
...
| Path | SHA-256 |
|---|---|
| `fixtures/isa/lds.hsaco` | `0be2c7f616f2bb47c93d26004e6d8e6f17e9e9c4465668ced3b1128b8b44153f` |
...
| Key | Value |
|---|---|
| `code_object:lds.hsaco` | `0be2c7f616f2bb47c93d26004e6d8e6f17e9e9c4465668ced3b1128b8b44153f` |
...
| `selected_identity_sha256` | `c41aac9c41d525b40506aada9a488801d33fe291192a569c68ca48b7b2081fdc` |
