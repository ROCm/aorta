...
Sanitizer case `consan-lds-dispatch` from run `2026-09-11T124542-34598790075` of the AORTA sanitizer nightly. This directory is the run area for that one case: its report, the sanitizer output the verdict came from, and the provenance below. See `index.html` for every file actually published here.
...
| Path | SHA-256 |
|---|---|
| `fixtures/isa/lds.hsaco` | `daf9807ad2fb5b4db5c71b3e2db066b45ac6342332c2a0dba8ad88df0608710f` |
...
| Key | Value |
|---|---|
| `code_object:lds.hsaco` | `daf9807ad2fb5b4db5c71b3e2db066b45ac6342332c2a0dba8ad88df0608710f` |
...
| `selected_identity_sha256` | `f048b4c274eba883bf4269805f4810c34d9bc7a71ffb1fdcb029ce91ce942f3d` |
