...
Sanitizer case `consan-tiny` from run `2026-09-11T124542-34598790075` of the AORTA sanitizer nightly. This directory is the run area for that one case: its report, the sanitizer output the verdict came from, and the provenance below. See `index.html` for every file actually published here.
...
| Path | SHA-256 |
|---|---|
| `fixtures/isa/tiny.hsaco` | `4b895b3572d93a2b275352e84dcf2c62abfccb796ea614ea0e24c9627ed17c53` |
...
| Key | Value |
|---|---|
| `code_object:tiny.hsaco` | `4b895b3572d93a2b275352e84dcf2c62abfccb796ea614ea0e24c9627ed17c53` |
...
| `selected_identity_sha256` | `68e6e9dad8ca41ddf99fe07312dd252a09abfcbf1c72e431e66c5dcc85f85894` |
