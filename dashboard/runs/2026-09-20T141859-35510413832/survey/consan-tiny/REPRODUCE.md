...
Sanitizer case `consan-tiny` from run `2026-09-20T141859-35510413832` of the AORTA sanitizer nightly. This directory is the run area for that one case: its report, the sanitizer output the verdict came from, and the provenance below. See `index.html` for every file actually published here.
...
| Path | SHA-256 |
|---|---|
| `fixtures/isa/tiny.hsaco` | `2230d10c8aaff0c2afd20389f4dfa4420fbfd4706376a9ea889f1e5a3ff73fcf` |
...
| Key | Value |
|---|---|
| `code_object:tiny.hsaco` | `2230d10c8aaff0c2afd20389f4dfa4420fbfd4706376a9ea889f1e5a3ff73fcf` |
...
| `selected_identity_sha256` | `31f4036af25b7dd80b0fc06b432ede151f6e05d98443df1c042e629b17fd2a9d` |
