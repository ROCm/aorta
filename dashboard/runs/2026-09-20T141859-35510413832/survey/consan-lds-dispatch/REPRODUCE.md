...
Sanitizer case `consan-lds-dispatch` from run `2026-09-20T141859-35510413832` of the AORTA sanitizer nightly. This directory is the run area for that one case: its report, the sanitizer output the verdict came from, and the provenance below. See `index.html` for every file actually published here.

## Run

- Commit: `684b4600dbb52b96603a27c553e995c183458403`
- Date: 2026-09-20 14:18:59 UTC
- Target: `gfx950`
- Class: survey (observed-only, non-gating)
- Workflow run: https://github.com/ROCm/aorta/actions/runs/35510413832
...
| Path | SHA-256 |
|---|---|
| `fixtures/isa/lds.hsaco` | `d1a4ac98c38149adc9b6b5340d3a2f5ef45bfa7b6bc24de421ce373e2c5e5cb2` |
...
| Key | Value |
|---|---|
| `code_object:lds.hsaco` | `d1a4ac98c38149adc9b6b5340d3a2f5ef45bfa7b6bc24de421ce373e2c5e5cb2` |
...
| `selected_identity_sha256` | `dfa6f77336b707d648c56a76be2ae40828b248634d28292dd52064d0fa7b7178` |
