...
Sanitizer case `consan-lds-dispatch` from run `2026-08-22-32572213077` of the AORTA sanitizer nightly. This directory is the run area for that one case: its report, the sanitizer output the verdict came from, and the provenance below. See `index.html` for every file actually published here.
...
| Path | SHA-256 |
|---|---|
| `fixtures/isa/lds.hsaco` | `d21304e8b7d146140af60d1ce83648045c51bb10415b7283d5ce243f8e8de4d8` |
...
| Key | Value |
|---|---|
| `code_object:lds.hsaco` | `d21304e8b7d146140af60d1ce83648045c51bb10415b7283d5ce243f8e8de4d8` |
...
| `selected_identity_sha256` | `668d17b04dbd4b67596134c015a160aadc45b2b35c315781a42656d7e7b55f9d` |
