...
Sanitizer case `consan-lds-dispatch` from run `2026-08-31T125804-33391758880` of the AORTA sanitizer nightly. This directory is the run area for that one case: its report, the sanitizer output the verdict came from, and the provenance below. See `index.html` for every file actually published here.
...
| Path | SHA-256 |
|---|---|
| `fixtures/isa/lds.hsaco` | `6fca835a6ffe427d7f9c2ac21cd0b88e879152bc46bcf99926d3b3942d54abcd` |
...
| Key | Value |
|---|---|
| `code_object:lds.hsaco` | `6fca835a6ffe427d7f9c2ac21cd0b88e879152bc46bcf99926d3b3942d54abcd` |
...
| `selected_identity_sha256` | `7295c9ce64c46b5efed63bf03e6bf706e14d3496948518894e36e92fcef12a5e` |
