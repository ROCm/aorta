...
Sanitizer case `consan-tiny` from run `2026-08-31T125804-33391758880` of the AORTA sanitizer nightly. This directory is the run area for that one case: its report, the sanitizer output the verdict came from, and the provenance below. See `index.html` for every file actually published here.
...
| Path | SHA-256 |
|---|---|
| `fixtures/isa/tiny.hsaco` | `5216bfa04501e765307acd1a575f9b63299793b793098e91c44c1f8ea3d0eda4` |
...
| Key | Value |
|---|---|
| `code_object:tiny.hsaco` | `5216bfa04501e765307acd1a575f9b63299793b793098e91c44c1f8ea3d0eda4` |
...
| `selected_identity_sha256` | `58dbd2f18c9e535160a7bc64008fd9e8b7fdfc49ebfa3a6e3ccd9da7723ff2b6` |
