...
Sanitizer case `consan-lds-dispatch` from run `2026-09-23T142606-35860346694` of the AORTA sanitizer nightly. This directory is the run area for that one case: its report, the sanitizer output the verdict came from, and the provenance below. See `index.html` for every file actually published here.
...
| Path | SHA-256 |
|---|---|
| `fixtures/isa/lds.hsaco` | `fee591749d45a569bcf4bfdaca4d2e1d76c1ef3681fbb22339de4f89dcd82d8e` |
...
| Key | Value |
|---|---|
| `code_object:lds.hsaco` | `fee591749d45a569bcf4bfdaca4d2e1d76c1ef3681fbb22339de4f89dcd82d8e` |
...
| `selected_identity_sha256` | `06e42cd7d80cd3c2b2794ed0e1735fceea107286ac912dff743c0327412df290` |
