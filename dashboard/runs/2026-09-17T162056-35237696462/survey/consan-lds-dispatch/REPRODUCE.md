...
Sanitizer case `consan-lds-dispatch` from run `2026-09-17T162056-35237696462` of the AORTA sanitizer nightly. This directory is the run area for that one case: its report, the sanitizer output the verdict came from, and the provenance below. See `index.html` for every file actually published here.
...
| Path | SHA-256 |
|---|---|
| `fixtures/isa/lds.hsaco` | `461c28a3e5caa05acc48ed294ddbf61257603e274b89895fd6773052958e909a` |
...
| Key | Value |
|---|---|
| `code_object:lds.hsaco` | `461c28a3e5caa05acc48ed294ddbf61257603e274b89895fd6773052958e909a` |
...
| `selected_identity_sha256` | `313eb6a7f17ef2aa7f7a54d02e7f4819f37a95f6d315fce9fa9a4aca4762be42` |
