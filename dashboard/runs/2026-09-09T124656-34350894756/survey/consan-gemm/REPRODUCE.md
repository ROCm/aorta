...
Sanitizer case `consan-gemm` from run `2026-09-09T124656-34350894756` of the AORTA sanitizer nightly. This directory is the run area for that one case: its report, the sanitizer output the verdict came from, and the provenance below. See `index.html` for every file actually published here.

## Run

- Commit: `6a8c70da0addc997c2d7067a5ed28d043464d9b8`
- Date: 2026-09-09 12:46:56 UTC
- Target: `gfx950`
- Class: survey (observed-only, non-gating)
- Workflow run: https://github.com/ROCm/aorta/actions/runs/34350894756
