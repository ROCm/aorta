...
Sanitizer case `consan-lds-dispatch` from run `2026-09-09T124656-34350894756` of the AORTA sanitizer nightly. This directory is the run area for that one case: its report, the sanitizer output the verdict came from, and the provenance below. See `index.html` for every file actually published here.
...
| Path | SHA-256 |
|---|---|
| `fixtures/isa/lds.hsaco` | `e2c61afad3dc634ca2127f1492d2ecc0613fd806895f099fbc700b57132a466d` |
...
| Key | Value |
|---|---|
| `code_object:lds.hsaco` | `e2c61afad3dc634ca2127f1492d2ecc0613fd806895f099fbc700b57132a466d` |
...
| `selected_identity_sha256` | `dffaf21edab32d9faa5e273b555c1e71c490264bacf067d8c7766093342d47a3` |
