...
Sanitizer case `consan-lds-dispatch` from run `2026-08-23-32638584704` of the AORTA sanitizer nightly. This directory is the run area for that one case: its report, the sanitizer output the verdict came from, and the provenance below. See `index.html` for every file actually published here.
...
- Workflow run: https://github.com/ROCm/aorta/actions/runs/32638584704
...
| Path | SHA-256 |
|---|---|
| `fixtures/isa/lds.hsaco` | `82e8e0ca1dae20c3625aec1d59d846f24cd17791467d2b1a0f36b43709f646b2` |
...
| Key | Value |
|---|---|
| `code_object:lds.hsaco` | `82e8e0ca1dae20c3625aec1d59d846f24cd17791467d2b1a0f36b43709f646b2` |
...
| `selected_identity_sha256` | `8b7eb4f918c87cc8144bbb3e000ad2bd5d972f16d5d787a8917b8d80121606ca` |
