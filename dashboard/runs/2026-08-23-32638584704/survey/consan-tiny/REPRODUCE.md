...
Sanitizer case `consan-tiny` from run `2026-08-23-32638584704` of the AORTA sanitizer nightly. This directory is the run area for that one case: its report, the sanitizer output the verdict came from, and the provenance below. See `index.html` for every file actually published here.
...
| Path | SHA-256 |
|---|---|
| `fixtures/isa/tiny.hsaco` | `e93f041b4a82b4bf48bb2758d4ca3de084a25e1dcbd0e2496f6090b1d73affa3` |
...
| Key | Value |
|---|---|
| `code_object:tiny.hsaco` | `e93f041b4a82b4bf48bb2758d4ca3de084a25e1dcbd0e2496f6090b1d73affa3` |
...
| `selected_identity_sha256` | `5e78584d6b9d0dbf66581c4a4ea2805f9ea65a31aeaad2608a1ea0d293a31307` |
