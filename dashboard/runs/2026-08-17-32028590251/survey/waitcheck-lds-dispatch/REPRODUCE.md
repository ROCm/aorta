...
Sanitizer case `waitcheck-lds-dispatch` from run `2026-08-17-32028590251` of the AORTA sanitizer nightly. This directory is the run area for that one case: its report, the sanitizer output the verdict came from, and the provenance below. See `index.html` for every file actually published here.
...
| Path | SHA-256 |
|---|---|
| `fixtures/isa/lds.hsaco` | `bb54caa237a6deea2423e5b73202021cc7e4b49cece533412f70dd1d5c4268ea` |

## Recorded digests

| Key | Value |
|---|---|
| `code_object:lds.hsaco` | `bb54caa237a6deea2423e5b73202021cc7e4b49cece533412f70dd1d5c4268ea` |
