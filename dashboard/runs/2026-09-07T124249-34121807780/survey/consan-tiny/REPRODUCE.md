...
Sanitizer case `consan-tiny` from run `2026-09-07T124249-34121807780` of the AORTA sanitizer nightly. This directory is the run area for that one case: its report, the sanitizer output the verdict came from, and the provenance below. See `index.html` for every file actually published here.
...
| Path | SHA-256 |
|---|---|
| `fixtures/isa/tiny.hsaco` | `bb3c19b5da190d53e90bb0546f5f4d63a8cd4442a20157178b7a700e975de6ec` |
...
| Key | Value |
|---|---|
| `code_object:tiny.hsaco` | `bb3c19b5da190d53e90bb0546f5f4d63a8cd4442a20157178b7a700e975de6ec` |
...
| `selected_identity_sha256` | `e4bad0017c88389b0288ca129d1ac2cf9ceed1e6487dcbba1537c6b928909153` |
