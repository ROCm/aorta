...
Sanitizer case `consan-lds-dispatch` from run `2026-09-07T124249-34121807780` of the AORTA sanitizer nightly. This directory is the run area for that one case: its report, the sanitizer output the verdict came from, and the provenance below. See `index.html` for every file actually published here.

## Run

- Commit: `d5a8bba0383e88f983a16cc1617e89b80b7faaa7`
- Date: 2026-09-07 12:42:49 UTC
- Target: `gfx950`
- Class: survey (observed-only, non-gating)
- Workflow run: https://github.com/ROCm/aorta/actions/runs/34121807780
...
git checkout d5a8bba0383e88f983a16cc1617e89b80b7faaa7
pip install -e .
```
...
| Path | SHA-256 |
|---|---|
| `fixtures/isa/lds.hsaco` | `8735a7c7fa5c745d1bbe852e4d572070c90732ae2c6aad95d9fb8121affc61a8` |
...
| Key | Value |
|---|---|
| `code_object:lds.hsaco` | `8735a7c7fa5c745d1bbe852e4d572070c90732ae2c6aad95d9fb8121affc61a8` |
...
| `selected_identity_sha256` | `7f8020df04722e06dbf213fd6913f9c8b1ad16f6187a287b04af565d716f86a0` |
