...
Sanitizer case `consan-gemm` from run `2026-09-08T124853-34225959457` of the AORTA sanitizer nightly. This directory is the run area for that one case: its report, the sanitizer output the verdict came from, and the provenance below. See `index.html` for every file actually published here.

## Run

- Commit: `d84bea127a2ee89949970caa8956df99cb3996e4`
- Date: 2026-09-08 12:48:53 UTC
- Target: `gfx950`
- Class: survey (observed-only, non-gating)
- Workflow run: https://github.com/ROCm/aorta/actions/runs/34225959457
...
- Execution: `error`
- Findings: 0
- Reason: `consan_coverage_incomplete: verdict analysis_complete=false; verdict static_complete=false; incomplete_code_objects=1; access patched/supported mismatch: 0/719550; barrier patched/supported mismatch: 0/109497; access placement_or_lowering_failed: 719550 instrumentation_patch_missing; barrier placement_or_lowering_failed: 109497 instrumentation_patch_missing`
...
git checkout d84bea127a2ee89949970caa8956df99cb3996e4
pip install -e .
```
