...
Sanitizer case `consan-lds-dispatch` from run `2026-09-08T124853-34225959457` of the AORTA sanitizer nightly. This directory is the run area for that one case: its report, the sanitizer output the verdict came from, and the provenance below. See `index.html` for every file actually published here.
...
| Path | SHA-256 |
|---|---|
| `fixtures/isa/lds.hsaco` | `1e6802ac3c7b2e22514e1b554dea622e0477f406dde016b63930ee8c20a62cb5` |
...
| Key | Value |
|---|---|
| `code_object:lds.hsaco` | `1e6802ac3c7b2e22514e1b554dea622e0477f406dde016b63930ee8c20a62cb5` |
...
| `selected_identity_sha256` | `d6c7652ebf9f3fcf485946799d6925af7cc47201d78ea7c6053f43b989732d79` |
