...
Sanitizer case `consan-tiny` from run `2026-09-08T124853-34225959457` of the AORTA sanitizer nightly. This directory is the run area for that one case: its report, the sanitizer output the verdict came from, and the provenance below. See `index.html` for every file actually published here.
...
| Path | SHA-256 |
|---|---|
| `fixtures/isa/tiny.hsaco` | `a3263992a597e405d0caa74de3de91f216fa6b04ba49505889e9b275bf0abfcb` |
...
| Key | Value |
|---|---|
| `code_object:tiny.hsaco` | `a3263992a597e405d0caa74de3de91f216fa6b04ba49505889e9b275bf0abfcb` |
...
| `selected_identity_sha256` | `f4792ba950900d2efec1fe0f309bb300ecaf2a253ea296c29e7c648d02c1d086` |
