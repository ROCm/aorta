...
Sanitizer case `consan-lds-dispatch` from run `2026-09-04T124232-33872660689` of the AORTA sanitizer nightly. This directory is the run area for that one case: its report, the sanitizer output the verdict came from, and the provenance below. See `index.html` for every file actually published here.
...
| Path | SHA-256 |
|---|---|
| `fixtures/isa/lds.hsaco` | `e8b9c9904ee331260253fbdee9903f242528a4711436b40506eac7c3d1dc9843` |
...
| Key | Value |
|---|---|
| `code_object:lds.hsaco` | `e8b9c9904ee331260253fbdee9903f242528a4711436b40506eac7c3d1dc9843` |
...
| `selected_identity_sha256` | `73e36dd2ae744b1a44921673020e2a0c120dc3423d5e70775e3ffc4e0fdc73b4` |
