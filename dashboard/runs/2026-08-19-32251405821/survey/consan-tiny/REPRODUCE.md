...
Sanitizer case `consan-tiny` from run `2026-08-19-32251405821` of the AORTA sanitizer nightly. This directory is the run area for that one case: its report, the sanitizer output the verdict came from, and the provenance below. See `index.html` for every file actually published here.
...
- Workflow run: https://github.com/ROCm/aorta/actions/runs/32251405821
...
| Path | SHA-256 |
|---|---|
| `fixtures/isa/tiny.hsaco` | `bdabd3454e3404302331dcfc0750f8543531a2c33c0332b6f636d636be4a74d8` |
...
| Key | Value |
|---|---|
| `code_object:tiny.hsaco` | `bdabd3454e3404302331dcfc0750f8543531a2c33c0332b6f636d636be4a74d8` |
...
| `selected_identity_sha256` | `f62763110b7bf2ae2d63ec6f2247d52a99aa4f5f7ef773c1ef1b3612c2709961` |
