...
Sanitizer case `consan-lds-dispatch` from run `2026-09-05T123756-33965800908` of the AORTA sanitizer nightly. This directory is the run area for that one case: its report, the sanitizer output the verdict came from, and the provenance below. See `index.html` for every file actually published here.
...
| Path | SHA-256 |
|---|---|
| `fixtures/isa/lds.hsaco` | `6bae96302ad2f2f93911ce9f6ddcade7109f122d6be0152445e89eb19e87f0a3` |
...
| Key | Value |
|---|---|
| `code_object:lds.hsaco` | `6bae96302ad2f2f93911ce9f6ddcade7109f122d6be0152445e89eb19e87f0a3` |
...
| `selected_identity_sha256` | `3135935bdb6bc793cc62946fcab6a84a6d5c44f39c457d777b8e0070f2fa43bd` |
