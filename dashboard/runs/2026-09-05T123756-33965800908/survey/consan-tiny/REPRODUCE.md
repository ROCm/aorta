...
Sanitizer case `consan-tiny` from run `2026-09-05T123756-33965800908` of the AORTA sanitizer nightly. This directory is the run area for that one case: its report, the sanitizer output the verdict came from, and the provenance below. See `index.html` for every file actually published here.
...
| Path | SHA-256 |
|---|---|
| `fixtures/isa/tiny.hsaco` | `7e7e19e27fe6f409ddaca24c32092776f94093b42252a56d0077450627e5c535` |
...
| Key | Value |
|---|---|
| `code_object:tiny.hsaco` | `7e7e19e27fe6f409ddaca24c32092776f94093b42252a56d0077450627e5c535` |
...
| `selected_identity_sha256` | `f7ff5e559d320781b2adb6ec09fff27d222c22fbd3b01c8b498c73d8c6456280` |
