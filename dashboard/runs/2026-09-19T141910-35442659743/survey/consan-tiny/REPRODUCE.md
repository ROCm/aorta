...
Sanitizer case `consan-tiny` from run `2026-09-19T141910-35442659743` of the AORTA sanitizer nightly. This directory is the run area for that one case: its report, the sanitizer output the verdict came from, and the provenance below. See `index.html` for every file actually published here.
...
| Path | SHA-256 |
|---|---|
| `fixtures/isa/tiny.hsaco` | `b20c76735867749fc3d7cc753a004d245a3577f98e57a5c9228c1c907249e048` |
...
| Key | Value |
|---|---|
| `code_object:tiny.hsaco` | `b20c76735867749fc3d7cc753a004d245a3577f98e57a5c9228c1c907249e048` |
...
| `selected_identity_sha256` | `c3b71c912c36cf857c014898f419894c89bd1412e3facd13f8fdcd7a50645b90` |
