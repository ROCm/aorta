...
Sanitizer case `consan-lds-dispatch` from run `2026-09-02T124713-33629901482` of the AORTA sanitizer nightly. This directory is the run area for that one case: its report, the sanitizer output the verdict came from, and the provenance below. See `index.html` for every file actually published here.
...
| Path | SHA-256 |
|---|---|
| `fixtures/isa/lds.hsaco` | `f2400031babe3633b66ec4201f265a2aabdc436527024fd1a4caa2790745a5c6` |
...
| Key | Value |
|---|---|
| `code_object:lds.hsaco` | `f2400031babe3633b66ec4201f265a2aabdc436527024fd1a4caa2790745a5c6` |
...
| `selected_identity_sha256` | `5346a7df3f78d3a16123f8cda960837a3123e1654e5e64c203f0a5c22babb539` |
