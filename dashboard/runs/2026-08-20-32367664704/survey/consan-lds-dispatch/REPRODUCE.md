...
Sanitizer case `consan-lds-dispatch` from run `2026-08-20-32367664704` of the AORTA sanitizer nightly. This directory is the run area for that one case: its report, the sanitizer output the verdict came from, and the provenance below. See `index.html` for every file actually published here.
...
- Workflow run: https://github.com/ROCm/aorta/actions/runs/32367664704
...
| Path | SHA-256 |
|---|---|
| `fixtures/isa/lds.hsaco` | `13c353bd538c0cae12317df2a20aa383612bb90d4b5cb9d855b8daf14fb93d18` |
...
| Key | Value |
|---|---|
| `code_object:lds.hsaco` | `13c353bd538c0cae12317df2a20aa383612bb90d4b5cb9d855b8daf14fb93d18` |
...
| `selected_identity_sha256` | `f11d178cbf0df7143a4530ae9b47472799c9bce5aabcc29b73874bc829534683` |
