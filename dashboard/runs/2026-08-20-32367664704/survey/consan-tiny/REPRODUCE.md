...
Sanitizer case `consan-tiny` from run `2026-08-20-32367664704` of the AORTA sanitizer nightly. This directory is the run area for that one case: its report, the sanitizer output the verdict came from, and the provenance below. See `index.html` for every file actually published here.
...
| Path | SHA-256 |
|---|---|
| `fixtures/isa/tiny.hsaco` | `067bfb7a3f7c01a1ac33ffcf96a39aa670b981e514f58836ee4392f28b701358` |
...
| Key | Value |
|---|---|
| `code_object:tiny.hsaco` | `067bfb7a3f7c01a1ac33ffcf96a39aa670b981e514f58836ee4392f28b701358` |
...
| `selected_identity_sha256` | `67f8214ad13341d60e71220fc167c77b215e96a43f1bd30567ec33b6b36b37bf` |
