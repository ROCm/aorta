...
Run `2026-08-16-31946286609` · commit `b4be48fdd6dd` · 2026-08-16
...
| Sanitizer | Code | Severity | Count | Example |
|---|---|---|--:|---|
| consan | `1` | race | 64 | [rocjitsu-dbi-hooks] ConSan MOI auto replay diagnostic reader=36683920 index=0 kind=1 code_object=fnv1a64:7db8350dfcf3fedf report_generation=2 generation=2 epo… |
...
| Kernel | Dispatch | Observed sanitizer verdict | Findings | Code object | SHA-256 |
|---|--:|---|--:|---|---|
| `lds_reduce` | 1 | `error` | 0 | `lds.hsaco` | `e8e1f2ad6e` |
...
| Kernel | Dispatch | Observed sanitizer verdict | Findings | Code object | SHA-256 |
|---|--:|---|--:|---|---|
| `tiny_vecadd` | 1 | `error` | 0 | `tiny.hsaco` | `47b99b2d25` |
...
| Kernel | Dispatch | Observed sanitizer verdict | Findings | Code object | SHA-256 |
|---|--:|---|--:|---|---|
| `lds_reduce` | 1 | `pass` | 0 | `lds.hsaco` | `e8e1f2ad6e` |
...
| Kernel | Dispatch | Observed sanitizer verdict | Findings | Code object | SHA-256 |
|---|--:|---|--:|---|---|
| `tiny_vecadd` | 1 | `pass` | 0 | `tiny.hsaco` | `47b99b2d25` |
