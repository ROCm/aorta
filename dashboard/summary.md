...
Run `2026-08-17-32028590251` · commit `b4be48fdd6dd` · 2026-08-17
...
| Sanitizer | Code | Severity | Count | Example |
|---|---|---|--:|---|
| consan | `1` | race | 64 | [rocjitsu-dbi-hooks] ConSan MOI auto replay diagnostic reader=16087424 index=0 kind=1 code_object=fnv1a64:7db8350dfcf3fedf report_generation=2 generation=2 epo… |
...
| Kernel | Dispatch | Observed sanitizer verdict | Findings | Code object | SHA-256 |
|---|--:|---|--:|---|---|
| `lds_reduce` | 1 | `error` | 0 | `lds.hsaco` | `bb54caa237` |
...
| Kernel | Dispatch | Observed sanitizer verdict | Findings | Code object | SHA-256 |
|---|--:|---|--:|---|---|
| `tiny_vecadd` | 1 | `error` | 0 | `tiny.hsaco` | `ed78603326` |
...
| Kernel | Dispatch | Observed sanitizer verdict | Findings | Code object | SHA-256 |
|---|--:|---|--:|---|---|
| `lds_reduce` | 1 | `pass` | 0 | `lds.hsaco` | `bb54caa237` |
...
| Kernel | Dispatch | Observed sanitizer verdict | Findings | Code object | SHA-256 |
|---|--:|---|--:|---|---|
| `tiny_vecadd` | 1 | `pass` | 0 | `tiny.hsaco` | `ed78603326` |
