...
from aorta.laya.eval import score
from aorta.laya.gate import (
    CONTEXT_WINDOWS,
    LATENCY_BATCHES,
    LOWER_IS_BETTER,
    PRIMARY_METRIC,
...
from aorta.laya.predictor import Choice, FakeLayaPredictor, Noul, NoulAnswer
...
class TestTheVerdict:
    ...
    def test_every_thresholded_primary_metric_has_an_operating_point(self):
        ...
        answers."""
        from aorta.laya.eval import DEFAULT_THRESHOLDS
    ...
    def test_every_decision_the_builders_emit_has_a_primary_metric(self):
        ...
        from aorta.laya.corpus.schema import DECISIONS
