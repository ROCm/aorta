"""What an exported classifier artifact has to say about itself before it is trusted.
...
class TestTheTemperatureBucket:
    ...
    def test_it_agrees_with_the_eval_harness(self):
        ...
        ``aorta.local_classifier.eval`` fits a temperature per (question type, option
        ...
        from aorta.local_classifier.eval import calibration_key as eval_key
...
class TestLoadingAnArtifact:
    ...
    def test_an_absent_artifact_prints_the_staging_procedure(self, tmp_path):
        ...
        assert "AORTA_CHAT_LOCAL_CLASSIFIER_ARTIFACT_PATH" in message
