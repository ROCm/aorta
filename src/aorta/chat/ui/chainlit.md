...
- **Run commands** -- execute sandboxed commands like `pytest`, `grep`, `ls`, and `python` inside the AORTA repo
...
| *"Run pytest tests/ and show me the results"* | Executes tests in a sandbox |
